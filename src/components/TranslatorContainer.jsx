...
const TranslatorContainer = () => {
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (e) => {
      console.log("🔽 Key pressed:", e.code, "isRecording:", isRecording, "target:", e.target.tagName);
    ...
    const handleKeyUp = (e) => {
      console.log("🔼 Key released:", e.code, "isRecording:", isRecording);
    ...
    <div className="translator-container">
      ...
      <div className="controls">
        <button
          ...
          onClick={() => {
            console.log("🖱️ Microphone button clicked, isRecording:", isRecording);
            if (isRecording) {
